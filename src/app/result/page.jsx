...
//                   let {data} = await axios.post('https://exam.elevateegy.com/api/v1/questions/check',{
...
//     <div className='w-[686px] h-[361px] p-5 bg-red-400 rounded-[20px] mt-10 flex justify-center items-center   '>

//     <div className='bg-green-500 p-5'>
      
//       {result}
//       {correctQuestions.correct.map((question,index)=>(
