      ...
      {!question ? (
        ...
        <div className="p-6 fixed inset-0 flex items-center justify-center bg-black bg-opacity-30">
          ...
          <div className='flex justify-center gap-8'>
            <button className='w-[295px] h-[56px] border border-blue-500 rounded-full'>Back</button>
            <button className='w-[295px] h-[56px] border bg-[#1D1B201F] rounded-full'>Next</button>
          </div>
